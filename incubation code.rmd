...
ndc<-reshape2::dcast(nd[,c("site","season","treatment","collectDate","doc_conc")],site+season+collectDate~treatment,mean)
nd_ss<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","SR")],site+season+collectDate~treatment,mean)
nd_comp5f<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","comp5f")],site+season+collectDate~treatment,mean)
nd_comp4f<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","comp4f")],site+season+collectDate~treatment,mean)
nd_comp3f<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","comp3f")],site+season+collectDate~treatment,mean)
nd_comp2f<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","comp2f")],site+season+collectDate~treatment,mean)
nd_comp1f<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","comp1f")],site+season+collectDate~treatment,mean)
nd_comp1f<-reshape2::dcast(nd[,c("site","season","collectDate","treatment","comp1f")],site+season+collectDate~treatment,mean)
...
neon_grab_chem<-readRDS('/Users/jdh/Library/CloudStorage/GoogleDrive-jakehosen@gmail.com/My Drive/Active Grants/MSB NEON SUNA Project/NeonAncillaryData/experiment_grab_chem_merged.rds')
...
ndc3$field_mean_annual_temperature_C<-as.numeric(gsub("°C","",ndc3$field_mean_annual_temperature_C,fixed=TRUE))
...
swwide<-reshape::dcast(swdata[,c("siteID","date","collectDate","analyteConcentration","analyte")], siteID + date + collectDate ~ analyte , mean, value.var="analyteConcentration") # average effect of time
